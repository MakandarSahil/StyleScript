...
export function AuthForm({ className, ...props }: React.ComponentPropsWithoutRef<"form">) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isSignup) {
      ...
      console.log({ email, password }) // Replace with actual login logic
    }
  }
    ...
    <form onSubmit={handleSubmit} className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          {isSignup ? "Sign up to get started" : "Enter your email below to login to your account"}
        </p>
      </div>
      ...
      <div className="text-center text-sm">
        ...
        <button type="button" onClick={() => setIsSignup(!isSignup)} className="underline underline-offset-4">
