                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {["full", "half"].map((type) => (
                        <button
                          key={type}
                          className={`border rounded-md py-3 px-3 flex flex-col items-center justify-center text-sm font-medium h-16 ${sleeveType === type ? "bg-blue-600 text-white border-blue-600" : "bg-white text-gray-900 border-gray-200 hover:bg-gray-50"}`}
                          onClick={() => setSleeveType(type as "full" | "half")}
                        >
                          <span>{type === "full" ? "Full Sleeve" : "Half Sleeve"}</span>
                          <span className="text-xs mt-1 opacity-70">{type === "full" ? "Classic fit" : "Casual style"}</span>
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      disabled={isLoading}
                    >
                      {isLoading ? <><Loader2 className="mr-2 h-5 w-5 animate-spin" />Processing...</> : "Generate Design"}
                    </button>
                  </div>
                </div>
              )}
              ...
              {activeTab === "preview" && (
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600">Here's your customized shirt design. You can download it or share it with friends.</p>
                  ...
                  <div className="flex space-x-3">
                    <button className="flex-1 border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 rounded-md py-2 px-4 flex items-center justify-center" onClick={() => setActiveTab("customize")}>
                      <Undo2 className="mr-2 h-4 w-4" />Edit Design
                    </button>
