...
import { Loader2, Download, Share2, Undo2, ShoppingCart, ArrowLeft, Heart } from "lucide-react"
import ClothViewer from "@/components/ClothViewer"

// Default item data in case navigation state is missing
const defaultItem = {
  id: "tshirt",
      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-2">Customize your {item.name}</p>
          </div>
        </header>
                  ...
                  <div>
                    ...
                    <div className="mt-6 border-t pt-6">
                      ...
                      <div className="flex justify-between items-center font-medium mb-6">
                        ...
                        <span className="text-lg">${(item.price * quantity).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
