...
// const CatalogItem = () => {
//   const { itemId } = useParams(); // access the dynamic part of the route
...
//   // const modelPath = "/models/shirt_full.glb"
//   const modelPath = shirtModel
