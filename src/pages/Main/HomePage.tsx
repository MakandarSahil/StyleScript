  ...
  return (
    <div className="min-h-screen">
      <div className="absolute right-0 h-full w-full">
        ...
        <video src="src\assets\landingComp.mp4" className="-z-10 w-[100%] h-[90%] object-cover" autoPlay loop muted playsInline />
      </div>
      <BackgroundLines className="w-full flex flex-col items-center justify-center py-3 lg:py-16 px-4">
        ...
        <Link className="z-10 mt-6" to='/chats'><Button className="bg-zinc-900 hover:bg-200 hover:text-zinc-200 border-2 border-black px-10 rounded-md">Get Color Recommendations</Button>
        </Link>
      </BackgroundLines>
      ...
      <div className="flex flex-col items-center justify-center h-[40rem]  ">
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
          <Link to='/catalog'><Button className="bg-zinc-900 hover:bg-200 hover:text-zinc-200 border-2 border-black px-10 rounded-md">Create Your Design</Button>
          </Link>
